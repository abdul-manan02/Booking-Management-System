    ...
    return (
        <>
            ...
            <form>
                ...
                <label style={{ width: '150px', marginLeft: '-50px', marginTop: '30px' }}>Fare Calculated is:</label>

                <input type="text" value={fare}
                    onChange={(e) => setFare(e.target.value)}
                    style={{ width: '150px', marginLeft: '-50px', marginTop: '30px', height: "25px" }} />

                <button
                    style={{ width: '130px', marginLeft: '-50px', height: '40px', marginTop: '100px' }}
